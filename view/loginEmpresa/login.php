<div class="row">
    <div class="col-xs-12 " id="tituloLoguin"> <h2 class="center-block FuenteTitulo tamanioFuente2">Iniciar Sesión Empresa</h2></div> 
</div>
<form action = "<?php echo "index.php?controller=LoginEmpresa&action=login"; ?>" method="post" >
