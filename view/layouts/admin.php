                ...
                <div id="d2_1" class="">
                    <nav class="lato tamanioFuente1">
                        ...
                        if ($_SESSION['adm_tipo_administrador'] == 1) {
                            ?>
                            <a  id="opcion1" href = "<?php echo "index.php?controller=Administrador&action=index"; ?>">
                                Administrador
                                <p class="circulo"></p>
                            </a>  
                            <?php
                        ...
                        <a id="opcion11" href = "<?php echo "index.php?controller=Sorteo&action=index"; ?>">
                            Sorteos
                            <p class="circulo"></p>
                        </a>
                        <a id="opcion12" href = "<?php echo "index.php?controller=SorteoUsuario&action=index"; ?>">
                            Sorteo Usuario
                            <p class="circulo"></p>
                        </a>
                        <a id="opcion13" href = "<?php echo "index.php?controller=movimientoSaldo&action=index"; ?>">
                            Movimiento Saldo
                            <p class="circulo"></p>
                        </a>
                    </nav>
